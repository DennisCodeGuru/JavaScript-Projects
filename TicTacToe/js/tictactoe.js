...
function placeXOrO(squareNumber) {
    ...
    //This function results in a random sqere being selected.
    function computersTurn() {
        ...
        while(!success) {
            //A random number betvween 0 and 8 is selected.
            pickASquare = String(Math.floor(Math.random() * 9));
            //If the random number evalueted reterns true, the square hasn't been selected yet.
...
//This function parses yhe selectedSquares array to search for win conditions.
...
function checkWinConditions() {
    ...
    // O 0, 1, 2 condition.
    else if (arrayIncludes('0O', '1O', '2OX')) { drawWinLine(50, 100, 558, 100) }
    // O 3, 4, 5 condition.
    ...
    // O 2, 5, 8 condition.
    else if (arrayIncludes('2O', '5O', '8OX')) { drawWinLine(508, 50, 508, 558) }
    // O 6, 4, 2 condition.
    else if (arrayIncludes('6O', '4O', '2O')) { drawWinLine(100, 508, 510, 90) }
    // O 0, 4, 8 condition.
    else if (arrayIncludes('0O', '4O', '8O')) { drawWinLine(100, 100, 520, 520) }
    //This condition checks for tie. If none of the above conditionsregister and 9
    ...
    //This function checks if an array 3 strings. it is used to check for 
    //each win condition.
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //reterned and our else if condition executes the drawWinLine function.
...
function disableClick() {
    ...
    //This makes our body clickable again after 1 srcond.
...
//This line accesses our html canvas element.
    ...
    let x1 = coordX1,
        ...
        //This line indicates where the start of a lines x axis is.
        y2 = coordY2,
        //This variable stores temporary x axis data we uodate in our animation loop.
        x = x1,
        //This variable stores temporary x axis data we uodate in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        c.strokeStile = 'rgba(70, 255, 33, .8)';
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //This removes our elements backgraundImage.
